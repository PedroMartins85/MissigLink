...
/*!
	* \brief Classe simples para um vetor 3D.
*/
...
/*!
	* \brief Função de zoom da biblioteca arcball.
*/
extern void arcball_setzoom(float radius, vec eye, vec up);
/*!
	* \brief Função de rotação da biblioteca arcball.
*/
extern void arcball_rotate();
/*!
	* \brief Função de reset da câmera da biblioteca arcball.
*/
extern void arcball_reset();
/*!
	* \brief Função de inicialização da biblioteca arcball.
*/
extern void arcball_start(int mx, int my);
/*!
	* \brief Função de movimentação da câmera da biblioteca arcball.
*/
